...
export default function Contact({ navigate: _navigate }: ContactProps) {
  ...
  return (
    <main style={{ paddingTop: 70 }}>
      ...
      {/* ── ENGAGEMENT HUB ──────────────────────────────────── */}
      <section
        style={{ background: "#F8FAFC", paddingTop: 80, paddingBottom: 80 }}
        className="px-6 lg:px-12"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
          {/* Left: contact channels — 2 columns */}
          <div className="lg:col-span-2 flex flex-col gap-5">
            <div className="mb-2">
              <h2
                style={{ fontSize: "1.2rem", fontWeight: 700, color: "#0B1D35", letterSpacing: "-0.01em" }}
              >
                Direct Channels
              </h2>
              <p style={{ marginTop: 4, fontSize: "0.875rem", color: "#6B8CAE" }}>
            ...
            >
              ...
              <div>
                <div style={{ fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#8AA0BD", marginBottom: 2 }}>
                  Email
                </div>
                <div style={{ fontSize: "0.875rem", fontWeight: 600, color: "#0055E5" }}>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "0.75rem", color: "rgba(248,250,252,0.40)" }}>
                      Solutions Engineer
                    </div>
                  </div>
                </div>
              ...
              {[
                {
                  ...
                  icon: (
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="#0055E5">
                ...
                },
                {
                  ...
                  icon: (
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="#0B1D35">
          ...
          >
            {submitted ? (
              <div className="flex flex-col items-center gap-5 py-14 text-center">
                ...
                <div>
                  <h3 style={{ fontSize: "1.3rem", fontWeight: 700, color: "#0B1D35" }}>
                    Message Received
                  </h3>
                  <p style={{ marginTop: 6, fontSize: "0.875rem", color: "#6B8CAE", maxWidth: 300 }}>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                <div>
                  <h2
                    style={{ fontSize: "1.3rem", fontWeight: 700, color: "#0B1D35", letterSpacing: "-0.01em" }}
                  >
                ...
                <div className="flex flex-col gap-2">
                  <label
                    style={{ fontSize: "0.75rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#8AA0BD" }}
                  >
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    onBlur={(e) => ((e.target as HTMLInputElement).style.borderColor = "#DDE4EE")}
                  />
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    onBlur={(e) => ((e.target as HTMLTextAreaElement).style.borderColor = "#DDE4EE")}
                  />
                </div>

                <div className="flex flex-col gap-2 mt-1">
                  {status === "error" && (
                    <p role="alert" style={{ fontSize: "0.8rem", color: "#B91C1C", lineHeight: 1.5 }}>
                      {errorMessage}
                    </p>
                  )}
                  <button
                  ...
                  <p style={{ fontSize: "0.75rem", textAlign: "center", color: "#8AA0BD" }}>
                ...
                >
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke={openFaq === i ? "#38BDF8" : "rgba(248,250,252,0.5)"}
                      strokeWidth="2.5"
                      strokeLinecap="round"
                    >
