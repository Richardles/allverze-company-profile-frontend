  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          opacity: hovered ? 1 : 0,
          transform: hovered ? "scale(1) translateX(0)" : "scale(0.92) translateX(8px)",
          pointerEvents: "none",
        }}
      >
        <div
          className="px-4 py-2.5 rounded-2xl rounded-br-sm text-sm font-semibold text-white whitespace-nowrap"
          style={{
        ...
        <div
          className="text-xs font-medium mt-1 mr-1"
          style={{ color: "#38BDF8" }}
        >
